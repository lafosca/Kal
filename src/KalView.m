...
- (void)addSubviewsToHeaderView:(UIView *)headerView
{
  ...
  UIImageView *backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"assets/kal_grid_background.png"]];
  ...
  [previousMonthButton setImage:[UIImage imageNamed:@"assets/kal_left_arrow.png"] forState:UIControlStateNormal];
  ...
  headerTitleLabel.textColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"assets/kal_header_text_fill.png"]];
  ...
  [nextMonthButton setImage:[UIImage imageNamed:@"assets/kal_right_arrow.png"] forState:UIControlStateNormal];
...
- (void)addSubviewsToContentView:(UIView *)contentView
{
  ...
  shadowView.image = [UIImage imageNamed:@"assets/kal_grid_shadow.png"];
